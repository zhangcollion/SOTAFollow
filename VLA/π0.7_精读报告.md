...
<img src="https://www.pi.website/_next/image?url=%2Fimages%2Fpi07%2Fpi07-og.png&w=3840&q=75" alt="π0.7 Teaser" width="900">

> **图 1**（来源：PI 官网 `https://www.pi.website/pi07`）：π0.7 在多种机器人平台上执行多样化任务的能力展示
...
> **图 2**（来源：π0.7 论文 Figure 1）：π0.7 整体架构图，展示 VLM Backbone + MEM History Encoder + Action Expert 的数据流，以及多模态 Context 条件化信号
...
> **图 3**（来源：π0.7 论文 Algorithm 1）：π0.7 推理流程伪代码，包含子目标图像异步生成与 action chunk 异步执行
...
> **图 6**（来源：π0.7 论文 Figure X）：π0.7 与 π*₀.6 RL Specialist 在多种灵巧操控任务上的性能对比
...
> **图 7**（来源：π0.7 论文 Figure X）：π0.7 在未见厨房/卧室环境中对 3-6 步指令序列的跟随成功率对比
...
<img src="https://www.pi.website/_next/image?url=%2Fimages%2Fpi07%2Fcurrent_1.png&w=3840&q=75" alt="π0.7 跨本体迁移" width="600">
<img src="https://www.pi.website/_next/image?url=%2Fimages%2Fpi07%2Fcurrent_3.png&w=3840&q=75" alt="π0.7 衬衫折叠" width="600">

> **图 4**（来源：π0.7 论文 Figure X / PI 官网）：（左）π0.7 从小型静态双臂机器人（source）迁移到大型 UR5e 双臂机器人（target），进行衬衫折叠任务；（右）衬衫折叠的详细操控过程
...
<img src="https://www.pi.website/_next/image?url=%2Fimages%2Fpi07%2Fsubgoal_1.png&w=3840&q=75" alt="π0.7 Coaching" width="600">
<img src="https://www.pi.website/_next/image?url=%2Fimages%2Fpi07%2Fsubgoal_3.png&w=3840&q=75" alt="π0.7 目标图像" width="600">

> **图 5**（来源：π0.7 论文 Figure X / PI 官网）：（左）π0.7 通过人类 step-by-step 口头指令（Coaching）学习新任务；（右）世界模型生成的子目标图像（Subgoal Image），为策略提供视觉化的目标状态

**语言 Coaching 范式**：π0.7 可通过人类口头指令 step-by-step 指导来学习新任务（如用空气炸锅烹饪）。Coaching 数据进一步训练高层语言策略，实现完全自主执行，5 个新长周期任务验证了此路径的有效性。

### 4.5 数据规模与多样性缩放（§IX-E）

> **图 8**（来源：π0.7 论文 Figure X）：数据规模与多样性缩放曲线，验证有/无 Metadata 情况下数据量对性能的影响
